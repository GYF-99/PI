<template lang="">
    <div class="main-container">
        <div class="main-header">
            <a class="menu-link-main" href="#">主题市场</a>
            <div class="header-menu">
                <router-link to="/fashionclothing" active-class="is-active">时尚女装</router-link>
                <router-link to="/trendyshoes" active-class="is-active">潮流女鞋</router-link>
