    ...
    <div class="main-container">
        ...
        <div class="content-wrapper">
            <div class="content-section qx">
                ...
                <ul>
                    <li class="content-button status-button" @click="singerlist(1)">高跟鞋</li>
                    <li class="content-button status-button" @click="singerlist(2)">运动鞋</li>
                    <li class="content-button status-button" @click="singerlist(3)">休闲鞋</li>
                    <li class="content-button status-button" @click="singerlist(4)">品质皮鞋</li>
                </ul>
                <div class="apps-card">
