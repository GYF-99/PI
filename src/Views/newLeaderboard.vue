<template lang="">
    <div class="main-container">
        <div class="main-header">
            <div class="main-header">
                <a class="menu-link-main" href="/newLeaderboard">新品排行榜</a>
                <div class="header-menu">
                    <!-- <router-link to="/" active-class="is-active">今日爆款</router-link>
                    <router-link to="/Leaderboard" active-class="is-active">好物金榜</router-link> -->
