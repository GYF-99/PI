<template lang="">
    <div class="main-container">
        <div class="main-header">
            <a class="menu-link-main" href="#">潮流前线</a>
            <div class="header-menu">
                <!-- <router-link to="/fashionclothing" active-class="is-active">新衣服</router-link>
                <router-link to="/trendyshoes" active-class="is-active">新鞋</router-link> -->
