<template lang="">
    <div class="main-container">
        <div class="main-header">
            <div class="main-header">
                <a class="menu-link-main" href="#">时尚女装</a>
        ...
        <div class="content-wrapper">
            <div class="content-section qx">
                ...
                <ul>
                    <li class="content-button status-button" @click="singerlist(1)">连衣裙</li>
                    <li class="content-button status-button" @click="singerlist(2)">上衣</li>
                    <li class="content-button status-button" @click="singerlist(3)">下装</li>
                    <li class="content-button status-button" @click="singerlist(4)">外套</li>
                </ul>
                <div class="apps-card">
