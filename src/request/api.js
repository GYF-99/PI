...
//状态
export const getstatus = () => request.post("login/status")
//注销
export const userlogout = () => request.post("logout")
//获取用户信息
export const getuserinfo = () => request.post("user/subcount")
// 刷新登录状态
export const reflogin = () => request.get("login/refresh")
//用户歌单
export const getuserlist = (params) => request.get(`user/playlist?uid=${params.id}`)
//每日歌单
